...
const IndexPage = () => (
  <Layout>
    <div className='p-homepage__hero'>
      <div className='o-container o-container--title u-text-center'>
        <h1 className='u-mb-20'>
          ...
          You can <a href='#' className='c-link'>learn about me</a>, <a href='#' className='c-link'>my work</a>, or <a href='#' className='c-link u-color-gray-dark'>contact me</a>.
        </h1>
      </div>
    </div>
    ...
    <div className='o-container'>
      <div className='o-grid o-grid--wide'>
        <div className='o-grid__col u-7/12@md u-mb-40'>
          ...
          <p><strong>Hello once again!</strong> I appreciate you taking a look at my portfolio. I am Jason Yeung, currently a student studying Computer Science at <a href='#'>Simon Fraser University</a> in BC, Canada.  John Ryan by Design needed a website that reflected their true expertise and reputation.</p>
          <h6 className='u-mt-40 u-mb-16'>How do I make things look good?</h6>
          <p>Hello once again! I appreciate you taking a look at my portfolio. I am Jason Yeung, currently a student studying Computer Science at Simon Fraser University in BC, Canada.  John Ryan by Design needed a website that reflected their true expertise and reputation. A website with a vast amount of information, customers rely upon heavily. Some of the goals were to make this feature more and be more readily available, as well as communicate a level of trust.</p>
        </div>

        <div className='o-grid__col u-5/12@md'>
          <span className='c-label c-label--alt u-inline-block u-mb-24'>Development</span>
          ...
          <span className='c-label c-label--alt u-inline-block u-mb-20'>Design</span>
    ...
    <div className='o-container o-container--content u-text-center'>
      ...
      <p className='u-color-black u-mb-60'>Below are some projects I have been working on. My work consists of personal projects, some useful, others just plain silly.</p>
    </div>
          ...
          <div className='o-grid__col u-6/12@md u-mb-40'>
            <div className='p-homepage__work-item'>
              ...
              <div className='p-homepage__work-desc u-pt-20 u-pb-32 u-ph-32'>
                <h6 className='c-subhead u-mb-4'>Do you love Fluffy</h6>
                <p>Do you love Fluffy is a cute short minigame where the aim is to love Fluffy within a short amount of time.</p>
          ...
          <div className='o-grid__col u-6/12@md u-mb-40'>
            <div className='p-homepage__work-item'>
              ...
              <div className='p-homepage__work-desc u-pt-20 u-pb-32 u-ph-32'>
                ...
                <ul className='o-list o-list--inline u-mt-20'>
                  <li><a href='#' className='c-link c-link--alt'>View Case Study</a></li>
                </ul>
              </div>
            </div>
          </div>
